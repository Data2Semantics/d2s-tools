...
/**
 * Extension of the {@link ECML2013IntersectionGraphKernel} to the Intersection Graph Path Kernel.
 * 
 * @author Gerben
 *
 */
public class ECML2013IntersectionGraphPathKernel extends ECML2013IntersectionGraphKernel {

	public ECML2013IntersectionGraphPathKernel(int maxLength, double discountFactor) {
		this(maxLength, discountFactor, true);
	}
	
	public ECML2013IntersectionGraphPathKernel(int maxLength, double discountFactor, boolean normalize) {
