...
public class MoleculeGraphExperiment extends KernelExperiment<WLUSubTreeKernel> {
	...
	public MoleculeGraphExperiment(WLUSubTreeKernel kernel, long[] seeds, LibSVMParameters svmParms, List<UGraph<String>> graphs, List<Double> labels, List<EvaluationFunction> evalFunctions) {
		super(kernel, seeds);
