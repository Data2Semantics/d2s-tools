...
public class LinkPredictionExperimentTest {
	...
	public void test() {
		...
		new LinkPredictionExperiment(set, new IntersectionGraphPathKernel(set.getGraphsA(), 2, 1), new IntersectionGraphPathKernel(set.getGraphsB(), 2, 1), 0.5, 0.5, seeds, cs).run();
